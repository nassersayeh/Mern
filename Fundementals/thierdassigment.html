...
<body id="body">
    ...
    <script>
        ...
        const getValueFromId(id)=(id) =>{document.getElementById(id).value;}
        cont setBackgroundColorById(id, color)=(id,color) =>{document.getElementById(id).style = "background-color: " + color;}
        const mouseOverFunction(el)=(el)=>{el.style = "background-color: black"; }
    </script>
</body>
</html>